...
object SecurePreferences {
    private const val PREFS_NAME = "tauanito_app_prefs_v12"
    ...
    fun isInitialized(context: Context): Boolean = getSharedPrefs(context).getBoolean(KEY_INITIALIZED, false)
    
    fun setInitialized(context: Context) {
        getSharedPrefs(context).edit().putBoolean(KEY_INITIALIZED, true).apply()
    }
